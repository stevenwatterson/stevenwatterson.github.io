<?php
	...
	if (isset($_POST['uname']) && $_POST['uname'] != "" && isset($_POST['pwd']) && $_POST['pwd'] != "") {
		...
		if ($login->login($_POST['uname'], $_POST['pwd']))
   		exit('<!DOCTYPE html><html><head><title>Loading...</title><meta http-equiv="refresh" content="1; url=index.php"></head><body><p style="text-align: center;">Loading...</p></body></html>');
		else
			$login_error = $l10n['private_area_login_error'];
	}
